 ...
 * Client5Frame.java
 *
 * Created on 19 janvier 2008, 16:19
 */
 ...
 * @author  Eric Beaudry
 */
public class Connect5 extends javax.swing.JFrame
 implements GrilleDisplayListener, GameObserver {
    ...
    protected Connect5Config config;
    ...
    public Connect5() {
        ...
        gameplay = new GamePlay(joueurGUI, joueurGUI, 12, 12);
    ...
    private void initComponents() {
        ...
        setTitle("IFT615/TP1 - Connect5  (2009H)");
        ...
        Runnable task = new Runnable(){
            public void run(){
                try{
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(Connect5.this, e);
                }
    ...
    private void configButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_configButtonActionPerformed
        if(config==null) config = new Connect5Config(this, true);
    ...
    public class JoueurGUI implements Joueur {
        ...
        public int[] getProchainCoup(Grille g, int delais) {
            ...
            while(true){
                ...
                if(g.get(prochainCoup[0], prochainCoup[1])!=0){
                    prochainCoup = null;
                    continue;
                }
                return prochainCoup;
