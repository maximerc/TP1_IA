 ...
 * Connect5Config.java
 *
 * Created on 19 janvier 2008, 21:09
 */
 ...
 * @author  Eric Beaudry
 */
public class Connect5Config extends javax.swing.JDialog {

    JoueurConfig jc1, jc2;

    /** Creates new form Connect5Config */
    public Connect5Config(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        ignorerRetardCB.setText("Ignorer les dépassements de temps");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Connect5Config dialog = new Connect5Config(new javax.swing.JFrame(), true);
